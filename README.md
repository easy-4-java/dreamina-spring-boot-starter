...
| JDK | `17` |
| Coordinates | `io.github.easy4j:dreamina-spring-boot-starter:3.5.x.20260630-SNAPSHOT` |
...
| `DreaminaCliAvailabilityChecker` | classpath + property | not created |
| `DreaminaCliStartupChecker` | classpath + property | not created |
